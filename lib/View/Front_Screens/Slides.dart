...
import 'package:foodmafia/View/Details_Screens/Slidesdetails.dart';
...
class Slides extends StatefulWidget {
  var email;
  Slides({required this.email });

  @override
  State<Slides> createState() => _SlidesState(email:email);
}
...
class _SlidesState extends State<Slides> {
  ...
  var Colour=[];
  var Size=[];
  _SlidesState({required this.email});
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Sandels',style: TextStyle(
                              ...
                              itemBuilder: (context, index) {
                                return Card(
                                  child: Consumer<Cart>(builder: (context, cart, child) {
                                    ...
                                    return InkWell(
                                      onTap: (){
                                        Navigator.push(context, MaterialPageRoute(builder: (context)=>Slidesdetails(
                                          index: index,
