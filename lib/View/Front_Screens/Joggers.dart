...
import 'package:foodmafia/View/Details_Screens/Joggerdetails.dart';
...
class Joggers extends StatefulWidget {
  var email;
  Joggers({required this.email });

  @override
  State<Joggers> createState() => _JoggersState(email:email);
}

class _JoggersState extends State<Joggers> {
  var email;
  ...
  var Colour=[];
  var Size=[];
  _JoggersState({required this.email});
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Runners',style: TextStyle(
                              ...
                              itemBuilder: (context, index) {
                                return Card(
                                  child: Consumer<Cart>(builder: (context, cart, child) {
                                    ...
                                    return InkWell(
                                      onTap: (){
                                        Navigator.push(context, MaterialPageRoute(builder: (context)=>Joggersdetails(
                                          index: index,
