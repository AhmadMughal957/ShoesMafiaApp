...
import 'package:foodmafia/View/Details_Screens/LoafersDetails.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Loafers',style: TextStyle(
                              ...
                              itemBuilder: (context, index) {
                                return Card(
                                  child: Consumer<Cart>(builder: (context, cart, child) {
                                    ...
                                    return InkWell(
                                      onTap: (){
                                        Navigator.push(context, MaterialPageRoute(builder: (context)=>Loaferdetails(
                                          index: index,
