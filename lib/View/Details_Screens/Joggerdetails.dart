...
class Joggersdetails extends StatefulWidget {
  var index;
  var image;
  var name;
  var price;
  ...
  var size=[];
  var colors=[];
  Joggersdetails ({required this.index,required this.name,required this.price,required this.desc,required this.size,required this.colors,required this.image});

  @override
  State<Joggersdetails> createState() => _JoggersdetailsState(name:name,price:price,desc: desc,size:size,colors: colors,image: image,index:index);
}

class _JoggersdetailsState extends State<Joggersdetails> {
  ...
  _JoggersdetailsState({required this.name,required this.price,required this.desc,required this.size,required this.colors,required this.image, required this.index});
