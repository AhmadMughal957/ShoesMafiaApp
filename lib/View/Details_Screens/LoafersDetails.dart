...
class Loaferdetails extends StatefulWidget {
  var index;
  var image;
  var name;
  var price;
  ...
  var size=[];
  var colors=[];
  Loaferdetails ({required this.index,required this.name,required this.price,required this.desc,required this.size,required this.colors,required this.image});

  @override
  State<Loaferdetails> createState() => _LoaferdetailsState(name:name,price:price,desc: desc,size:size,colors: colors,image: image,index:index);
}

class _LoaferdetailsState extends State<Loaferdetails> {
  ...
  _LoaferdetailsState({required this.name,required this.price,required this.desc,required this.size,required this.colors,required this.image, required this.index});
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          Padding(
                            padding: scaler.getPaddingLTRB(30, 1, 0, 6.5),
                            child: Container(
