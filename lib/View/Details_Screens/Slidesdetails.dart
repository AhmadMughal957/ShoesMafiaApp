...
class Slidesdetails extends StatefulWidget {
  ...
  var size=[];
  var colors=[];
  Slidesdetails ({required this.index,required this.name,required this.price,required this.desc,required this.size,required this.colors,required this.image});

  @override
  State<Slidesdetails> createState() => _SlidesdetailsState(name:name,price:price,desc: desc,size:size,colors: colors,image: image,index:index);
}
...
class _SlidesdetailsState extends State<Slidesdetails> {
  ...
  _SlidesdetailsState({required this.name,required this.price,required this.desc,required this.size,required this.colors,required this.image, required this.index});
